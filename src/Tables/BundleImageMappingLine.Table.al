table 62023 "Bundle Image Mapping Line"
{
    Caption = 'Bundle Image Mapping Line';
    ...
    fields
    {
        ...
        {
            Caption = 'Serial No.';
            TableRelation = "Bundle Image Mapping Header"."Serial No." WHERE("Bundle Code" = FIELD("Bundle Code"));
            DataClassification = CustomerContent;
        }
